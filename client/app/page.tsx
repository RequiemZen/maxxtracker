...
const HomePage = () => {
  ...
  return (
    // Added flex justify-center items-center to center content vertically
    <div className="flex flex-col items-center justify-center min-h-screen bg-dark-bg text-gray-200 p-8">
